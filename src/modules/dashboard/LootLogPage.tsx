...
export function LootLogPage() {
  ...
  return (
    <div className="dashboard-container" style={{ padding: '20px', maxWidth: '1700px', margin: '0 auto', color: '#f8fafc' }}>
      <header className="page-header" style={{ marginBottom: '20px', borderBottom: '1px solid #334155', paddingBottom: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h2 style={{ margin: 0, fontSize: '20px', color: '#10b981' }}>Log de Drops</h2>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="value" style={{ color: '#10b981' }}>{stats.soldCount}</div>
        </div>
        <div className="stat-card">
          <label>Pendentes</label>
          <div className="value" style={{ color: '#f59e0b' }}>{stats.pendingCount}</div>
        </div>
        <div className="stat-card">
          <label>Valor Total</label>
          <div className="value" style={{ color: '#10b981' }}>{formatTibiaGold(stats.totalValue)}</div>
        </div>
      </div>
